...
* Add support for combining crcs of parts > 4GB [Thodoris Greasidis]
* Update flowzone config [Thodoris Greasidis]
* .gitignore: Add the emsdk & the build output [Thodoris Greasidis]
* Add an npmrc to block lockfile creation [Thodoris Greasidis]
* Update mocha to unblock tests on node 26 [Thodoris Greasidis]
...
* Pin emscripten toolchain to v3.1.5 [Akis Kesoglou]
